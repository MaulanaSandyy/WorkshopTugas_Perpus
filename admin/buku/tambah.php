...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO buku (judul, pengarang, penerbit, tahun_terbit, isbn, jumlah_buku, gambar) 
                VALUES ('$judul', '$pengarang', '$penerbit', '$tahun_terbit', '$isbn', '$jumlah_buku', '$gambar')";
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pengarang" name="pengarang" value="<?= $_POST['pengarang'] ?? '' ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="penerbit" class="form-label">Penerbit</label>
                                    <input type="text" class="form-control" id="penerbit" name="penerbit" value="<?= $_POST['penerbit'] ?? '' ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tahun_terbit" class="form-label">Tahun Terbit</label>
                                    <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit" value="<?= $_POST['tahun_terbit'] ?? '' ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="isbn" class="form-label">ISBN (opsional)</label>
                                    <input type="text" class="form-control" id="isbn" name="isbn" value="<?= $_POST['isbn'] ?? '' ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah_buku" class="form-label">Jumlah Buku</label>
                                    <input type="number" class="form-control" id="jumlah_buku" name="jumlah_buku" value="<?= $_POST['jumlah_buku'] ?? 1 ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
